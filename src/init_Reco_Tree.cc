...
int event;
float                 time_CF[7];
float                 time_CF_corr[7];
float                 time_CF30[7];
float                 time_OT[7];
float                 time_start[7];
float                 time_stop[7];
float                 time_start_1000[7];
float                 time_stop_1000[7];
float                 time_start_150[7];
float                 time_stop_150[7];
float                 time_start_200[7];
float                 time_stop_200[7];
float                 time_start_500[7];
float                 time_stop_500[7];
float                 time_start_300[7];
float                 time_stop_300[7];
float                 time_Max[7];
float                 amp_max[7];
float                 amp_max_corr[7];
float                 amp_max_time[7];
float                 charge[7];
float                 charge_corr[7];
float                 baseline[7];
int                   sci_front_adc;
...
void SetOutTree(TTree* outTree)
{
  ...
  outTree->Branch("time_CF",&time_CF,"time_CF[7]/F");
  outTree->Branch("time_CF_corr",&time_CF_corr,"time_CF_corr[7]/F");
  outTree->Branch("time_CF30",&time_CF30,"time_CF30[7]/F");
  outTree->Branch("time_OT",&time_OT,"time_OT[7]/F");
  outTree->Branch("time_start",&time_start,"time_start[7]/F");
  outTree->Branch("time_stop",&time_stop,"time_stop[7]/F");
  outTree->Branch("time_start_1000",&time_start_1000,"time_start_1000[7]/F");
  outTree->Branch("time_stop_1000",&time_stop_1000,"time_stop_1000[7]/F");
  outTree->Branch("time_start_150",&time_start_150,"time_start_150[7]/F");
  outTree->Branch("time_stop_150",&time_stop_150,"time_stop_150[7]/F");
  outTree->Branch("time_start_200",&time_start_200,"time_start_200[7]/F");
  outTree->Branch("time_stop_200",&time_stop_200,"time_stop_200[7]/F");
  outTree->Branch("time_start_500",&time_start_500,"time_start_500[7]/F");
  outTree->Branch("time_stop_500",&time_stop_500,"time_stop_500[7]/F");
  outTree->Branch("time_start_300",&time_start_300,"time_start_300[7]/F");
  outTree->Branch("time_stop_300",&time_stop_300,"time_stop_300[7]/F");
  outTree->Branch("time_Max",&time_Max,"time_Max[7]/F");
  outTree->Branch("amp_max",&amp_max,"amp_max[7]/F");
  outTree->Branch("amp_max_corr",&amp_max_corr,"amp_max_corr[7]/F");
  outTree->Branch("amp_max_time",&amp_max_time,"amp_max_time[7]/F");
  outTree->Branch("charge",&charge,"charge[7]/F"); 
  outTree->Branch("charge_corr",&charge_corr,"charge_corr[7]/F");
  outTree->Branch("baseline",&baseline,"baseline[7]/F");
  ...
  //---additional branches
  outTree->Branch("isPCOn",&isPCOn,"isPCOn[7]/I");
  outTree->Branch("HV",&HV,"HV[7]/I");
  outTree->Branch("HV2",&HV2,"HV2[7]/I");
  outTree->Branch("isTrigger",&isTrigger,"isTrigger[7]/I");
