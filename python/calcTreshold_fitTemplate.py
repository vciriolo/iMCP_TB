...
if __name__ == '__main__':
    ...
    parser.add_argument ('-i', '--inputFile' , default = 'ntuples/reco_HVScan1.root' , help='input file')
    ...
    print 'calcTreshold_fitTemplate '+args.inputFile+' '+args.tresholdValue+' '+args.chNumber+' '+args.HV
    os.system('./calcTreshold_fitTemplate '+args.inputFile+' '+args.tresholdValue+' '+args.chNumber+' '+args.HV)
