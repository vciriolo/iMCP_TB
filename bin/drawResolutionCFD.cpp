...
//    legC->AddEntry(eff_GaAsEm_OFF, "GaAs emitt. - iMCP mode", "p");
 ...
 if(plot_type == "LongScan2X0"){
   legC = new TLegend(0.15,0.65,0.35,0.85,NULL,"brNDC");
    ...
    inF_Double9090 = TFile::Open("plots/resCFD_studies/Double9090_HV1_LongScan2X0_Double9090.root");
    inF_Double9040 = TFile::Open("plots/resCFD_studies/Double9040_HV1_LongScan2X0_Double9040.root");    
...
//    legC->AddEntry(eff_GaAsEm_OFF, "GaAs emitt. - iMCP mode", "p");
  ...
  if(plot_type == "saturated_HV12"){
    ...
    inF_Double9090 = TFile::Open("plots/resCFD_studies/Double9090_HV12_HVScan12_Double9090.root");
    inF_Double9040 = TFile::Open("plots/resCFD_studies/Double9040_HV12_HVScan12_Double9040.root");    
    TGraphErrors* eff_GaAsEm = (TGraphErrors*)inF_GaAsEm->Get("frac_saturated");
    TGraphErrors* eff_MultiAlkEm = (TGraphErrors*)inF_MultiAlkEm->Get("frac_saturated");
    TGraphErrors* eff_Double9040 = (TGraphErrors*)inF_Double9040->Get("frac_saturated");
    TGraphErrors* eff_Double9090 = (TGraphErrors*)inF_Double9090->Get("frac_saturated");
...
//    mg->Add(eff_GaAsEm_OFF);
    ...
    mg->GetXaxis()->SetTitle("HV_{1} (V)");
    mg->GetXaxis()->SetTitleSize(0.048);
    mg->GetYaxis()->SetTitle("% of saturated events");
    mg->GetYaxis()->SetTitleSize(0.048);
    mg->SetMaximum(100);
    mg->SetMinimum(0);
    mg->Draw("AP");  
 ...
 if(plot_type == "saturated_X0_12"){
    ...
    eff_GaAsEm = (TGraphErrors*)inF_GaAsEm->Get("frac_saturated");
    eff_MultiAlkEm = (TGraphErrors*)inF_MultiAlkEm->Get("frac_saturated");
    eff_Double9090 = (TGraphErrors*)inF_Double9090->Get("frac_saturated");
    eff_Double9040 = (TGraphErrors*)inF_Double9040->Get("frac_saturated");
