...
//    mg->Add(eff_GaAsEm_OFF);
    ...
    if(plot_type == "X0"){
    legC = new TLegend(0.15,0.15,0.55,0.42,NULL,"brNDC");
    ...
    legC->AddEntry(eff_MultiAlkEm, "MultiAlk emitt HV_{1} = -3800 HV_{2} = -3500 (V)", "p"); 
    legC->AddEntry(eff_GaAsEm, "GaAs emitt. HV_{1} = -3100 (V) HV_{2} = -3400 (V)", "p"); 
    //legC->AddEntry(eff_GaAsEm_OFF, "GaAs emitt. - iMCP mode", "p");
    legC->AddEntry(eff_Double9040, "Double9040 HV_{2} = 2700 (V)", "p");
    legC->AddEntry(eff_Double9090, "Double9090 HV_{2} = 2700 (V)", "p");
