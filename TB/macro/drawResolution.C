{
  ...
  if(HVE == "EffAll"){
    inF_MiB3_ON = TFile::Open("plots/time_resolution/time_MiB3_eff_HV_HVScan2.root");
    inF_MiB3_OFF = TFile::Open("plots/time_resolution/time_MiB3_eff_HV_HVScan7.root");
    inF_enSEE = TFile::Open("plots/time_resolution/time_enSEE_eff_HV_HVScan5.root");
    inF_ZStack1_ON = TFile::Open("plots/time_resolution/time_ZStack1_eff_HV_HVScan1.root");
    inF_ZStack1_OFF = TFile::Open("plots/time_resolution/time_ZStack1_eff_HV_HVScan8.root");
    inF_ZStack2_ON = TFile::Open("plots/time_resolution/time_ZStack2_eff_HV_HVScan2.root");
    inF_ZStack2_OFF = TFile::Open("plots/time_resolution/time_ZStack2_eff_HV_HVScan6.root");
  ...
  if(HVE == "AngScanHigh"){
  inF_MiB3 = TFile::Open("plots/time_resolution/time_MiB3_eff_X0_AngScan_HVHigh.root");
  inF_enSEE = TFile::Open("plots/time_resolution/time_enSEE_eff_X0_AngScan_HVHigh.root");
  inF_ZStack1 = TFile::Open("plots/time_resolution/time_ZStack1_eff_X0_AngScan_HVHigh.root");
  }
  if(HVE == "AngScanLow"){
  inF_MiB3 = TFile::Open("plots/time_resolution/time_MiB3_eff_X0_AngScan_HVLow.root");
  inF_enSEE = TFile::Open("plots/time_resolution/time_enSEE_eff_X0_AngScan_HVLow.root");
  inF_ZStack1 = TFile::Open("plots/time_resolution/time_ZStack1_eff_X0_AngScan_HVLow.root");
  }

  if(HVE == "HVH_50"){
  inF_MiB3 = TFile::Open("plots/time_resolution/time_MiB3_eff_X0_scanX0_HVHigh50GeV.root");
  inF_enSEE = TFile::Open("plots/time_resolution/time_enSEE_eff_X0_scanX0_HVHigh50GeV.root");
  inF_ZStack2 = TFile::Open("plots/time_resolution/time_ZStack2_eff_X0_scanX0_HVHigh50GeV.root");
  inF_ZStack1 = TFile::Open("plots/time_resolution/time_ZStack1_eff_X0_scanX0_HVHigh50GeV.root");
  }
  if(HVE == "HVH_20"){
  inF_MiB3 = TFile::Open("plots/time_resolution/time_MiB3_eff_X0_scanX0_HVHigh20GeV.root");
  inF_enSEE = TFile::Open("plots/time_resolution/time_enSEE_eff_X0_scanX0_HVHigh20GeV.root");
  inF_ZStack2 = TFile::Open("plots/time_resolution/time_ZStack2_eff_X0_scanX0_HVHigh20GeV.root");
  inF_ZStack1 = TFile::Open("plots/time_resolution/time_ZStack1_eff_X0_scanX0_HVHigh20GeV.root");
  }
  if(HVE == "HVL_50"){
  inF_MiB3 = TFile::Open("plots/time_resolution/time_MiB3_eff_X0_scanX0_HVLow50GeV.root");
  inF_enSEE = TFile::Open("plots/time_resolution/time_enSEE_eff_X0_scanX0_HVLow50GeV.root");
  inF_ZStack2 = TFile::Open("plots/time_resolution/time_ZStack2_eff_X0_scanX0_HVLow50GeV.root");
  inF_ZStack1 = TFile::Open("plots/time_resolution/time_ZStack1_eff_X0_scanX0_HVLow50GeV.root");
  }
  if(HVE == "HVL_20"){
  inF_MiB3 = TFile::Open("plots/time_resolution/time_MiB3_eff_X0_scanX0_HVLow20GeV.root");
  inF_enSEE = TFile::Open("plots/time_resolution/time_enSEE_eff_X0_scanX0_HVLow20GeV.root");
  inF_ZStack2 = TFile::Open("plots/time_resolution/time_ZStack2_eff_X0_scanX0_HVLow20GeV.root");
  inF_ZStack1 = TFile::Open("plots/time_resolution/time_ZStack1_eff_X0_scanX0_HVLow20GeV.root");
  }
