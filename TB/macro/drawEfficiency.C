{
  ...
  if(HVE == "EffAll"){
    inF_MiB3_ON = TFile::Open("plots/efficiency/efficiency_MiB3_eff_HV_HVScan2.root");
    inF_MiB3_OFF = TFile::Open("plots/efficiency/efficiency_MiB3_eff_HV_HVScan7.root");
    inF_enSEE = TFile::Open("plots/efficiency/efficiency_enSEE_eff_HV_HVScan5.root");
    inF_ZStack1_ON = TFile::Open("plots/efficiency/efficiency_ZStack1_eff_HV_HVScan1.root");
    inF_ZStack1_OFF = TFile::Open("plots/efficiency/efficiency_ZStack1_eff_HV_HVScan8.root");
    inF_ZStack2_ON = TFile::Open("plots/efficiency/efficiency_ZStack2_eff_HV_HVScan2.root");
    inF_ZStack2_OFF = TFile::Open("plots/efficiency/efficiency_ZStack2_eff_HV_HVScan6.root");
  ...
  if(HVE == "AngScanHigh"){
  inF_MiB3 = TFile::Open("plots/efficiency/efficiency_MiB3_eff_X0_AngScan_HVHigh.root");
  inF_enSEE = TFile::Open("plots/efficiency/efficiency_enSEE_eff_X0_AngScan_HVHigh.root");
  inF_ZStack1 = TFile::Open("plots/efficiency/efficiency_ZStack1_eff_X0_AngScan_HVHigh.root");
  }
  if(HVE == "AngScanLow"){
  inF_MiB3 = TFile::Open("plots/efficiency/efficiency_MiB3_eff_X0_AngScan_HVLow.root");
  inF_enSEE = TFile::Open("plots/efficiency/efficiency_enSEE_eff_X0_AngScan_HVLow.root");
  inF_ZStack1 = TFile::Open("plots/efficiency/efficiency_ZStack1_eff_X0_AngScan_HVLow.root");
  }
