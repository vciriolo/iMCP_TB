{
  ...
  if(HVE == "EffAll"){
    ...
    inF_MiB3_OFF = TFile::Open("plots/efficiency/efficiency_MiB3_no_eff_HV_HVScan7.root");
    inF_enSEE = TFile::Open("plots/efficiency/efficiency_enSEE_no_eff_HV_HVScan5.root");
    inF_ZStack1_ON = TFile::Open("plots/efficiency/efficiency_ZStack1_no_eff_HV_HVScan1.root");
    inF_ZStack1_OFF = TFile::Open("plots/efficiency/efficiency_ZStack1_no_eff_HV_HVScan8.root");
    inF_ZStack2_ON = TFile::Open("plots/efficiency/efficiency_ZStack2_no_eff_HV_HVScan2_dai.root");
    inF_ZStack2_OFF = TFile::Open("plots/efficiency/efficiency_ZStack2_no_eff_HV_HVScan6.root");
  }

  if(HVE == "AngScanHigh"){
  inF_MiB3_OFF = TFile::Open("plots/efficiency/efficiency_MiB3_no_eff_X0_AngScan_High.root");
  inF_enSEE = TFile::Open("plots/efficiency/efficiency_enSEE_no_eff_X0_AngScan_High.root");
  inF_ZStack1_OFF = TFile::Open("plots/efficiency/efficiency_ZStack1_no_eff_X0_AngScan_High.root");
  }
  if(HVE == "AngScanLow"){
  inF_MiB3_OFF = TFile::Open("plots/efficiency/efficiency_MiB3_no_eff_X0_AngScan_Low.root");
  inF_enSEE = TFile::Open("plots/efficiency/efficiency_enSEE_no_eff_X0_AngScan_Low.root");
  inF_ZStack1_OFF = TFile::Open("plots/efficiency/efficiency_ZStack1_no_eff_X0_AngScan_Low.root");
  }

  if(HVE == "HVH_50"){
  inF_MiB3 = TFile::Open("plots/efficiency/efficiency_MiB3_no_eff_X0_X0Scan_HVHigh_50GeV.root");
  inF_enSEE = TFile::Open("plots/efficiency/efficiency_enSEE_no_eff_X0_X0Scan_HVHigh_50GeV.root");
  inF_ZStack2 = TFile::Open("plots/efficiency/efficiency_ZStack2_no_eff_X0_X0Scan_HVHigh_50GeV.root");
  inF_ZStack1 = TFile::Open("plots/efficiency/efficiency_ZStack1_no_eff_X0_X0Scan_HVHigh_50GeV.root");
  }
  if(HVE == "HVH_20"){
  ...
  TGraphErrors* eff_MiB3_OFF = (TGraphErrors*)inF_MiB3->Get("eff");
  ...
  TGraphErrors* eff_ZStack1_OFF = (TGraphErrors*)inF_ZStack1->Get("eff");
  TGraphErrors* eff_ZStack2_OFF = (TGraphErrors*)inF_ZStack2->Get("eff");
  ...
  legC->AddEntry(eff_MiB3_OFF, "MiB3 chevron-OFF HV 3200", "p");
  legC->AddEntry(eff_ZStack1_OFF, "ZStack2 OFF HV 3200", "p");
  legC->AddEntry(eff_ZStack2_OFF, "ZStack1 OFF HV 3200", "p");
  ...
  eff_MiB3_OFF->GetYaxis()->SetTitle("Efficiency");
  eff_enSEE->GetXaxis()->SetTitle("Angle (degrees)");
  eff_enSEE->GetYaxis()->SetTitle("Efficiency");
  eff_ZStack1_OFF->GetXaxis()->SetTitle("Angle (degrees)");
  eff_ZStack1_OFF->GetYaxis()->SetTitle("Efficiency");
  */
  //  mg->Add(eff_MiB3_ON);
  mg->Add(eff_MiB3_OFF);
  ...
  /*
  eff_enSEE->GetXaxis()->SetLabelSize(0.05);
  eff_enSEE->GetXaxis()->SetTitleSize(0.05);
  eff_enSEE->GetYaxis()->SetLabelSize(0.05);
  eff_enSEE->GetYaxis()->SetTitleSize(0.05);
  eff_enSEE->SetMaximum(1.05);
  eff_enSEE->SetMinimum(0.);
  eff_enSEE->Draw("asp");
  eff_enSEE->GetXaxis()->SetRangeUser(1200,3500);
  eff_enSEE->Draw("asp");
