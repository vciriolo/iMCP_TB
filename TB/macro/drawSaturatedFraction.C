{
  ...
  gPad->SetTicks();
  if(HVE == "HVH_50" || "HVL_50" || "EffAll"){
    eff_enSEE->SetTitle("50 GeV");
    eff_enSEE->GetYaxis()->SetTitle("fraction of saturated events (%)");
    eff_enSEE->GetXaxis()->SetTitle("X0");
  }
  if(HVE == "HVH_20" || "HVL_20"){
    eff_enSEE->SetTitle("50 GeV");
    eff_enSEE->GetYaxis()->SetTitle("fraction of saturated events (%)");
    eff_enSEE->GetXaxis()->SetTitle("X0");
  }
  ...
  mg->GetXaxis()->SetTitle("HV");
  mg->GetYaxis()->SetTitle("fraction of saturated events (%)");
