...
if __name__ == '__main__':
    ...
    parser.add_argument ('-cfg', '--cfg' , default = 'cfg/treshold.txt' , help='cfg file containing treshold values')
    ...
    parser.add_argument ('-s', '--scan' , default = "HVScan", help='type of scan: HVScan=scan in HV, X0Scan = scan in X0')
